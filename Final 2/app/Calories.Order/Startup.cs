...
namespace Calories.Order
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHostedService<KafkaOrderService>(); //important
            services.AddHostedService<OutlogNotificationsSender>(); 
            ...
            {
                /*options.AddPolicy(AuthorizationPolicy.CruidAllUsers,
