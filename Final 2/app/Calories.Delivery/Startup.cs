...
using Calories.Delivery.Services;
...
namespace Calories.Delivery
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var settings = new DeliveryEnvironmentSettings();
            ...
            services.AddHostedService<KafkaDeliveryService>(); //important
            ...
            {
                options.AddPolicy(AuthorizationPolicy.GetAllDeliveries,
